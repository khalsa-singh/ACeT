%% Figure 2c: corrected ACeT versus comparator performance
% Required input:
%   figure2c_corrected_baselines.mat
%
% Bars: held-out test metrics
% Diamonds: five-fold CV means
% Open circles: individual CV-fold values
%
...
rng(0);  % deterministic jitter for fold points
...
scatter(1:4, mean(cv_r2,1), 100, 'd', ...
    'MarkerEdgeColor',diamondColor, ...
    'MarkerFaceColor',diamondColor);
for i = 1:4
    scatter(i + jitter(:,i), cv_r2(:,i), 80, 'o', ...
        'MarkerEdgeColor',circleEdgeColor, ...
